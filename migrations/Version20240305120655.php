 ...
 */
final class Version20240305120655 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TRIGGER TR_before_meta_category_specs_insert BEFORE INSERT ON meta_category_specs FOR EACH ROW 
        BEGIN 
    ...
    {
        $this->addSql('DROP TRIGGER if exists TR_before_meta_category_specs_insert');
    }
}
