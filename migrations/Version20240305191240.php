 ...
 */
final class Version20240305191240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (ctg_id INT AUTO_INCREMENT NOT NULL, ctg_name VARCHAR(255) NOT NULL, ctg_description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNQ_ctg_name (ctg_name), PRIMARY KEY(ctg_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE nations (ntn_type_id INT NOT NULL, ntn_ccTLD VARCHAR(2) NOT NULL, ntn_name VARCHAR(255) NOT NULL, INDEX IDX_BEC8200DD600C181 (ntn_type_id), PRIMARY KEY(ntn_ccTLD)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nations_types (nt_id INT AUTO_INCREMENT NOT NULL, nt_name VARCHAR(50) NOT NULL, nt_description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(nt_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (usr_id INT AUTO_INCREMENT NOT NULL, usr_email VARCHAR(180) NOT NULL, usr_roles JSON NOT NULL, usr_password VARCHAR(255) NOT NULL, UNIQUE INDEX UNQ_usr_email (usr_email), PRIMARY KEY(usr_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE nations ADD CONSTRAINT FK_BEC8200DD600C181 FOREIGN KEY (ntn_type_id) REFERENCES nations_types (nt_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nations DROP FOREIGN KEY FK_BEC8200DD600C181');
        ...
        $this->addSql('DROP TABLE nations_types');
