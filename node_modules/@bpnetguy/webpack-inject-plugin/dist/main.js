...
exports.injectEntry = exports.ENTRY_ORDER = exports.registry = void 0;
...
function getUniqueID() {
    ...
    return "webpack-inject-module-".concat(id);
}
var ENTRY_ORDER;
...
function injectToArray(originalEntry, newEntry, entryOrder) {
    ...
    if (entryOrder === ENTRY_ORDER.First) {
        return __spreadArray([newEntry], originalEntry, true);
    }
    if (entryOrder === ENTRY_ORDER.Last) {
        return __spreadArray(__spreadArray([], originalEntry, true), [newEntry], false);
    }
    return __spreadArray(__spreadArray(__spreadArray([], originalEntry.splice(0, originalEntry.length - 1), true), [
        newEntry
    ], false), originalEntry.splice(originalEntry.length - 1), true);
}
function createEntryFilter(filterOption) {
    ...
    throw new Error("Unknown entry filter: ".concat(typeof filterOption));
}
...
var WebpackInjectPlugin = /** @class */ (function () {
    ...
    WebpackInjectPlugin.prototype.apply = function (compiler) {
        ...
        var newEntry = path_1.default.resolve(__dirname, "".concat(FAKE_LOADER_NAME, "?id=").concat(id, "!"));
